...
class ObjectCentricEventlog:
    ...
    def from_eventlog(cls, eventlog: str | pl.DataFrame) -> "ObjectCentricEventlog":
        ...
        el_enriched = eventlog.with_columns(
            object_type_agent=pl.when(pl.col("org:resource").str.contains("agent"))
            .then(pl.lit("agent"))
            ...
            object_id_agent=pl.when(pl.col("object_type_agent") == "agent")
            .then(pl.col("org:resource"))
